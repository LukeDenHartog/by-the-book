                ...
                <section class="article-section">
                    ...
                    <ol>
                        <li>
                            ...
                            <ul>
                                <li>Admit to yourself that gambling is causing significant problems in your life.</li>
                            </ul>
                        </li>
                        <li>
                            <h3>Understand the Signs:</h3>
                            <ul>
                                <li> Be aware of common signs such as financial troubles, neglecting responsibilities, and emotional distress related to gambling.</li>
                            </ul>
                        </li>
                    </ol>
                </section>
